...
LBMixtureOfGaussians::LBMixtureOfGaussians(bool firstTime, bool showOutput, int sensitivity, int bgThreshold, int learningRate, int noiseVariance)
{
...
LBMixtureOfGaussians::LBMixtureOfGaussians() : firstTime(true), showOutput(true), sensitivity(81), bgThreshold(83), learningRate(49), noiseVariance(206)
{
  std::cout << "LBMixtureOfGaussians(" << firstTime << ", " << showOutput << ", " << sensitivity << ", " 
  << bgThreshold << ", " << learningRate << ", " << noiseVariance << ")" << std::endl;
}
